 ...
 */
public interface AdvanceUserRepository extends CrudRepository<User, Long>, QueryDslPredicateExecutor<User>, JpaSpecificationExecutor<User>{

	/**
	 * Find the user with the given username. This method will be translated into a query using the
	 * {@link javax.persistence.NamedQuery} annotation at the {@link com.wmv.poc.jpa.entity.User} class.
	 * 
	 * @param lastname
	 * @return
	 */
